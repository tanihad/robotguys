...
if __name__ == "__main__":
    ...
    for i in range(10000):
        ...
        goal_directions.append(goal_direction)
        ...
        # Visualization
        plt.figure(figsize=(10, 10), dpi=8.4)
    ...
    goal_directions_array = np.array(goal_directions)
    np.save('goal_directions.npy', goal_directions_array)
